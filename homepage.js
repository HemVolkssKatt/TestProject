        ...
        showMoreBtn.addEventListener('click', function () {
            ...
            <div class="product-item" data-id="9" data-name="Asgard">
                ...
                <div class="product-info">
                    <h3><a href="product.html">Asgard</a></h3>
            ...
            <div class="product-item" data-id="10" data-name="Bjursta">
                <div class="product-img-wrapper">
                    <a href="product.html"><img src="../assets/livingroom.jpg" alt="Bjursta"></a>
                    <div class="product-overlay">
                        <button class="add-to-cart">Add to cart</button>
                        <div class="overlay-actions">
                            <a href="#"><i class="fa-solid fa-share-nodes"></i> Share</a>
                ...
                <div class="product-info">
                    <h3><a href="product.html">Bjursta</a></h3>
            ...
            <div class="product-item" data-id="11" data-name="Klippan">
                <div class="product-img-wrapper">
                    <a href="product.html"><img src="../assets/lolito.png" alt="Klippan"></a>
                ...
                <div class="product-info">
                    <h3><a href="product.html">Klippan</a></h3>
            ...
            <div class="product-item" data-id="12" data-name="Hemnes">
                <div class="product-img-wrapper">
                    <a href="product.html"><img src="../assets/potty.jpg" alt="Hemnes"></a>
                ...
                <div class="product-info">
                    <h3><a href="product.html">Hemnes</a></h3>
